...
<body class="fix-header card-no-border">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Admin</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="add_admin.php">Display Users</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Edit Bus Detail</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="ad_index.php">Home</a></li>
                        <li class="breadcrumb-item">edit</li>
                         <li class="breadcrumb-item">edit_bus_detail</li>
            ...
            include("db.php");
            $editid=$_GET['id'];
            $q="select * from bus_detail where bus_id =('".$editid."')";
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="POST" action="edit_bus_process.php" >
                                    <input type="hidden" name="id" value="<?php echo $editdata[0];?>">
                                    <div class="form-body">
                                        <h3 class="card-title">Edit Bus Info</h3>
                                        <hr>
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Bus_no</label>
                                                    <input required="" type="text" name="ebno" class="form-control" value="<?php echo $editdata[1];?>">
                                                    </div>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Source Station</label>
                                                    <input type="text" name="esource" required="" class="form-control" value="<?php echo $editdata[2];?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Bus Description</label>
                                                    <textarea required="" name="edescription" class="form-control form-control-danger"><?php echo $editdata[8];?></textarea>
                                                    </div>
                                            </div>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Destionation station</label>
                                                    <input type="text" name="edestination" required="" class="form-control" value="<?php echo $editdata[3];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Source Time (H:M:AM/PM)</label>
                                                    <input  required="" type="Time" name="estime" class="form-control form-control-danger" value="<?php echo $editdata[4];?>">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Destination Time (H:M:AM/PM)</label>
                                                    <input  required="" type="Time" name="edtime" class="form-control form-control-danger" value="<?php echo $editdata[5];?>">
                                                    </div>
                                            </div>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Total no.seat</label>
                                                    <input  required="" type="text" name="etotalseat" class="form-control form-control-danger" value="<?php echo $editdata[7];?>">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Edit Bus date</label>
                                                    <input  required="" type="date" name="ebdate" class="form-control form-control-danger" value="<?php echo $editdata[6];?>">
                                                    </div>
                                            </div>
   ...
   <!--                                      <input type="submit" name="update" class="btn bnt-success" value="submit"> -->
                                        <button type="submit" name="update" class="btn btn-success"> <i class="fa fa-check"></i>Update Bus Detail</button>
