...
<body class="fix-header card-no-border">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Add_pickuppoint</li>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="POST" action="add_pickup_proccess.php" >
                                    <div class="form-body">
                                        <h3 class="card-title">Add PickupPoint</h3>
                                        <hr>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pickup" required="" class="form-control" placeholder="Enter pickup point">
                                                </div>
                                            </div>
   ...
   <!--                                      <input type="submit" name="addbus" class="btn bnt-success" value="submit"> -->
                                        <button type="submit" name="addpickup" class="btn btn-success"> <i class="fa fa-check"></i> Add PickupPoint</button>
