        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Display All Bus</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="ad_index.php">Home</a></li>
                        <li class="breadcrumb-item">manage bus</li>
                        <li class="breadcrumb-item active">display_allbus</li>
                    </ol>
                </div>
        ...
        ?>
            ...
            <div class="card-body">
                <form>
                    ...
                    <tr >
                        <td class="ro">ID</td>
                        <td class="ro">Bus_no</td>
                        <td class="ro">S_Station</td>
                        <td class="ro">D_Station</td>
                        <td class="ro">S_Time</td>
                        <td class="ro">D_Time</td>
                        <td class="ro">Bus_Date</td>
                        <td class="ro">Max-Seat</td>
                        <td class="ro">Bus_Detail</td>
            ...
            <?php 
                while($row=mysqli_fetch_array($result))
                {
                    ...
                    echo "<td>";
                    echo "<a href='edit_bus_detail.php?key=yes&id=".$row['bus_id']."'>edit</a>";
                    echo "</td>";
                    echo "<td>";
                    echo "<a href='delete_bus_detail.php?key=yes&id=".$row['bus_id']."'>delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            mysqli_close($con);
